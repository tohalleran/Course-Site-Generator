...
public class AppGUI {
    ...
    protected FlowPane leftFileToolbarPane;
    
    //THIS SPLITS THE FILETOOLBAR
    protected HBox fileToolbarPane;
    protected FlowPane rightFileToolbarPane;
    ...
    private void initFileToolbar(AppTemplate app) {
        leftFileToolbarPane = new FlowPane();

        // HERE ARE OUR FILE TOOLBAR BUTTONS, NOTE THAT SOME WILL
        // START AS ENABLED (false), WHILE OTHERS DISABLED (true)
        newButton = initChildButton(leftFileToolbarPane,	NEW_ICON.toString(),	    NEW_TOOLTIP.toString(),	false);
        loadButton = initChildButton(leftFileToolbarPane,	LOAD_ICON.toString(),	    LOAD_TOOLTIP.toString(),	false);
        saveButton = initChildButton(leftFileToolbarPane,	SAVE_ICON.toString(),	    SAVE_TOOLTIP.toString(),	true);
        saveAsButton = initChildButton(leftFileToolbarPane,	    SAVE_AS_ICON.toString(),    SAVE_AS_TOOLTIP.toString(),	true);
        exportButton = initChildButton(leftFileToolbarPane,	EXPORT_ICON.toString(),	    EXPORT_TOOLTIP.toString(),	true);
        exitButton = initChildButton(leftFileToolbarPane,	EXIT_ICON.toString(),	    EXIT_TOOLTIP.toString(),	false);
        
        //TRANSACTION/ABOUT TOOLBAR BUTTONS 
        rightFileToolbarPane = new FlowPane();
        
        // HERE ARE OUR FILE TOOLBAR BUTTONS, NOTE THAT SOME WILL
        // START AS ENABLED (false), WHILE OTHERS DISABLED (true)
        undoButton = initChildButton(rightFileToolbarPane, UNDO_ICON.toString(), UNDO_TOOLTIP.toString(), true);
        redoButton = initChildButton(rightFileToolbarPane, REDO_ICON.toString(), REDO_TOOLTIP.toString(), true);
        aboutButton = initChildButton(rightFileToolbarPane, ABOUT_ICON.toString(), ABOUT_TOOLTIP.toString(), false);
        
        //PUT FILE TOOLBAR BUTTONS IN HBOX PANE
        fileToolbarPane = new HBox(leftFileToolbarPane, rightFileToolbarPane);
        HBox.setHgrow(leftFileToolbarPane, Priority.ALWAYS);
